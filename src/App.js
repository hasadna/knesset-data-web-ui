            ...
            <header id="app-header" className="container">
                <div className="row">
                    <div id="logo" className="span4 clearfix">
                        <h1><a href="/"><img src={process.env.PUBLIC_URL + '/static/img/oknesset-logo.png'} alt="oknesset-logo"/><span>כנסת פתוחה</span></a>
                        </h1>
                    </div>
                </div>

                <ul className="nav nav-pills">
                    <li id="nav-parties"><a href="https://oknesset.org/members/index.html">ח"כים וסיעות</a></li>
                    <li id="nav-committees"><a href="https://oknesset.org/committees/index.html">ועדות</a></li>
                    <li id="nav-attendance"><a href="https://attendance.oknesset.org/">נוכחות</a></li>
                </ul>
            </header>
        )
    }
        ...
        return (
            <section className="container">
                <ul className="breadcrumb">
                    <li><a className="home-icon" href="https://oknesset.org/index.html">דף הבית</a><span className="divider">/</span></li>
                    <li><a href="https://attendance.oknesset.org/">נוכחות</a></li>
                </ul>
                <div id="content-main" className="main">
                    <div id="subnav">
                        <Link to="/committees">נוכחות בישיבות ועדה</Link>
                        &nbsp;|&nbsp;
                        <Link to="/presence">נוכחות במשכן</Link>
                    </div>
                    <div>
              ...
              <div id="dataSource" style={{display:'none'}}>
                  ...
                  <div className="container">
                      <div className="row">
                          <nav className="span8">
                              <ul className="nav nav-pills">
                                  <li><a className="home-icon" href="https://oknesset.org/index.html">דף הבית</a></li>
                                  <li><a href="https://oknesset.org/members/index.html">ח"כים וסיעות</a></li>
                                  <li><a href="https://oknesset.org/committees/index.html">ועדות</a></li>
                                  <li><a href="https://attendance.oknesset.org/">נוכחות</a></li>
                              </ul>
                          </nav>
                      </div>
                      <div className="row about">
                          ...
                          <div className="span4 offset4 hasadna">
                              <h3>
                                  <img src={process.env.PUBLIC_URL + '/static/img/sadna30x30.png'} alt="הסדנא לידע ציבורי" />
                                      <span>פרוייקט של</span><a href="http://www.hasadna.org.il">הסדנא לידע ציבורי</a>
                              </h3>
                              <ul>
                                  <li><a href="http://www.obudget.org/" target="_blank" rel="noopener noreferrer">מפתח התקציב</a></li>
                                  <li><a href="http://kikar.org/" target="_blank" rel="noopener noreferrer">כיכר המדינה</a></li>
                                  <li><a href="http://www.anyway.co.il/" target="_blank" rel="noopener noreferrer">ANYWAY</a></li>
                                  <li><a href="http://www.openpension.org.il/" target="_blank" rel="noopener noreferrer">פנסיה פתוחה</a></li>
                              </ul>
                              <form method="post" action="https://www.paypal.com/cgi-bin/webscr">
                                  <input type="hidden" value="_s-xclick" name="cmd" />
                                      <input type="hidden" value="K7X4FWYPBR7H4" name="hosted_button_id" />
                                          <input type="submit" name="submit" value="תרמו לסדנא"
                      ...
                      <div className="row">
                          <div className="span12"> חלק מהזכויות שמורות. שימוש בנתונים מהאתר בכפוף לקרדיט
                          </div>
                      </div>
                  </div>
            </footer>
